...
namespace StreamInsight.Samples.Adapters.SimpleTextFileWriter
{
    ...
    /// <summary>
    /// Pointversion of the simple text file writer output adapter.
    /// <para/>
    /// TextFilePointOutput adapter dequeues generic point events into a CSV file with the format:
    ...
    /// the documentation.
    /// </summary>
    public class TextFilePointOutput : PointOutputAdapter
    {
        /// <summary>
        /// Stream to write to.
        /// </summary>
