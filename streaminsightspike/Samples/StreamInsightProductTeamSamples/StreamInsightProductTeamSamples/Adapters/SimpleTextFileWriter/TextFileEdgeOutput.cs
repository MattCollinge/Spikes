...
namespace StreamInsight.Samples.Adapters.SimpleTextFileWriter
{
    ...
    /// <summary>
    /// Edge version of the simple text file writer output adapter.
    /// <para/>
    /// TextFileEdgeOutput adapter dequeues generic edge events into a CSV file with the format:
    ///   {EventKind}{delimiter}{EdgeType}{delimiter}{Starttime}{delimiter}{EndTime}{delimiter}{field2}{delimiter}...{fieldN}
    ...
    /// the documentation.
    /// </summary>
    public class TextFileEdgeOutput : EdgeOutputAdapter
    {
        /// <summary>
        /// Stream to write to.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the TextFileEdgeOutput class.
        /// </summary>
        ...
        public TextFileEdgeOutput(TextFileWriterConfig configInfo, CepEventType eventType)
        {
