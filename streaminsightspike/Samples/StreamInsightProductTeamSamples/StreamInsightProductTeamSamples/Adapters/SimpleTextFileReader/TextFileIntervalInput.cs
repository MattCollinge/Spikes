...
namespace StreamInsight.Samples.Adapters.SimpleTextFileReader
{
    ...
    /// <summary>
    /// Interval version of the simple text file reader input adapter.
    /// <para/>
    /// TextFileIntervalOutput adapter enqueues generic point events from a CSV file with the format:
    ///   {StartTime}{delimiter}{EndTime}{delimiter}{field1}{delimiter}...{fieldN}
    /// <para/>
    /// See additional notes in TextFilePointInput.cs
    /// </summary>
    public class TextFileIntervalInput : IntervalInputAdapter
    {
        /// <summary>
        /// Number of system field expected in each line by this adapter.
        /// Interval adapter expects start and end timestamps.
        /// </summary>
        private const int NumNonPayloadFields = 2;
        ...
        /// <summary>
        /// Initializes a new instance of the TextFileIntervalInput class.
        /// </summary>
        ...
        public TextFileIntervalInput(TextFileReaderConfig configInfo, CepEventType eventType)
        {
