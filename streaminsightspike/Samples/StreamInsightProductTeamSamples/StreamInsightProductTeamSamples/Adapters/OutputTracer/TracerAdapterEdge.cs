...
namespace StreamInsight.Samples.Adapters.OutputTracer
{
    ...
    /// <summary>
    /// Edge version of the tracer output adapter.
    /// </summary>
    internal sealed class TracerEdgeOutputAdapter : EdgeOutputAdapter
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the TracerEdgeOutputAdapter class, based on
        ...
        public TracerEdgeOutputAdapter(TracerConfig config, CepEventType type)
        {
        ...
        private void ConsumeEvents()
        {
            ...
            try
            {
                while (true)
                {
                    ...
                    {
                        string prefix = currentEvent.EdgeType == EdgeType.Start
                            ? String.Format(CultureInfo.InvariantCulture, "Edge start at {0}:", currentEvent.StartTime)
                            : String.Format(CultureInfo.InvariantCulture, "Edge end at {0} (start at {1}):", currentEvent.EndTime, currentEvent.StartTime);
