...
namespace AdvantIQ.ExampleAdapters.Output.ConsoleSimple
{
    ...
    /// </summary>
    public class ConsoleEdgeOutput<T> : TypedEdgeOutputAdapter<T>
    {
            ...
            try
            {
                ...
                while (AdapterState != AdapterState.Stopping)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Console.Write("[{0}-{1} {2}] ", currEvent.StartTime.ToString("T"), 
                                currEvent.EndTime.ToString("T"), currEvent.EdgeType.ToString());
                            var sep = "";
