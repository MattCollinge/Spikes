...
namespace AdvantIQ.StockInsight.OutputAdapters
{
    ...
    public class StockQuoteTypedPointOutput : TypedPointOutputAdapter<StockQuote>
    {
        ...
        {
            ChannelFactory<IConsoleDumper> consoleDumperFactory =
                new ChannelFactory<IConsoleDumper>(new NetNamedPipeBinding(),
                    new EndpointAddress("net.pipe://localhost/StockInsight"));
            consoleDumper = consoleDumperFactory.CreateChannel();
        }
